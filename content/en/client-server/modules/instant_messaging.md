...
uploaded using the [content repository module](#content-repository) where available. The
...
2.  If the room has an [m.room.canonical_alias](#m.room.canonical_alias) state event with a
