...
HTTP_APIS = {
    os.path.join(matrix_doc_dir, "data-sources/api/application-service"): "as",
    os.path.join(matrix_doc_dir, "data-sources/api/client-server"): "cs",
    os.path.join(matrix_doc_dir, "data-sources/api/identity"): "is",
    os.path.join(matrix_doc_dir, "data-sources/api/push-gateway"): "push",
    os.path.join(matrix_doc_dir, "data-sources/api/server-server"): "ss",
}
SWAGGER_DEFINITIONS = {
    os.path.join(matrix_doc_dir, "data-sources/api/application-service/definitions"): "as",
    os.path.join(matrix_doc_dir, "data-sources/api/client-server/definitions"): "cs",
    os.path.join(matrix_doc_dir, "data-sources/api/identity/definitions"): "is",
    os.path.join(matrix_doc_dir, "data-sources/api/push-gateway/definitions"): "push",
    os.path.join(matrix_doc_dir, "data-sources/api/server-server/definitions"): "ss",
}
EVENT_EXAMPLES = os.path.join(matrix_doc_dir, "data-sources/event-schemas/examples")
EVENT_SCHEMA = os.path.join(matrix_doc_dir, "data-sources/event-schemas/schema")
CORE_EVENT_SCHEMA = os.path.join(matrix_doc_dir, "data-sources/event-schemas/schema/core-event-schema")
...
class MatrixUnits:
    ...
    def read_event_schema(self, filepath):
        ...
        schema["content_fields"] = get_tables_for_schema(
            self.prop(json_schema, "properties/content")
        )

        # Include UnsignedData if it is present on the object
        unsigned = self.prop(json_schema, "properties/unsigned")
        if unsigned:
